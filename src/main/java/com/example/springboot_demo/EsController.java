...
import com.example.elasticsearch.util.EsModel;
import com.alibaba.fastjson.JSONObject;
import com.example.elasticsearch.util.ElasticsearchUtil;
import com.example.elasticsearch.util.EsPage;
...
public class EsController {
    ...
    public String insertJson() {
        ...
        jsonObject.put("id",df.format(new java.util.Date()));
    ...
    public String insertModel() {
        ...
        java.text.DateFormat df = new java.text.SimpleDateFormat("yyyy-MM-dd");
        esModel.setId(df.format(new java.util.Date()));
